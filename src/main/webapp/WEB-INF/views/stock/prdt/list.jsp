...
<div class="row-fluid">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">재고관리 > 완성품/반성품</div>
        </div>
...
var gridView = new tui.Grid({
    el: document.getElementById('prdtStockGridView'),
    data: [],
    ...
    columns: [
		...
		{header: '제품수량',    name: 'COUNT',    filter:{type:'text'},         	sortable:true,            align:'center', formatter :function(v) {
...
var prdtStock = {
	...
	/* productGubunSets:function(){
		...
		$.ajax({
		    url : "/stock/prdt/productGubunSets",
		    method :"POST",
		    data:params
...
var searchCombo = {
	...
	getProdIdRowList:function(){
		$.ajax({
		    url : "/stock/prdt/getProdIdRowList",
		    method :"POST",
		    data:{}
		}).success(function(result) {
...
$(function(){
	// 그리드 제어용
	$('#searchBtn').click(prdtStock.search);
