...
<div class="row-fluid">
    ...
    <div class="block">
        <div class="navbar navbar-inner block-header">
            <div class="muted pull-left">차종품명품호 리스트</div>
        </div>
      ...
      <div class="modal-body">
	      <form id="submitForm" class="form-horizontal" onsubmit="return false;">
	       <fieldset>
            ...
            <!--  <div class="control-group">
               <label class="col-sm-2 control-label" for="productId">원재료종류</label>
               <div class="controls">
                 <input class="input-xlarge focused skip" id="productId" name="productId" type="text" title="品號2" placeholder="品號2">
               </div>
             </div>
             <div class="control-group">
               <label class="col-sm-2 control-label" for="productId">원재료품명</label>
               <div class="controls">
                 <input class="input-xlarge focused skip" id="productId" name="productId" type="text" title="品號2" placeholder="品號2">
               </div>   
             </div> -->
