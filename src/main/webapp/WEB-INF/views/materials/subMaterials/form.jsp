				...
				<form:form modelAttribute="stockModel" cssClass="form-horizontal" method="post" action="" onsubmit="return stockForm.formChk(); return false;">
					<fieldset>						
						...
						<div class="control-group">
							...
							<div class="controls">
								<form:input path="stock.stockDate" class="input-xlarge date" title="日期"/>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<form:select path="stock.stockGubun" id="stockGubun" title="区分">
									<form:option value="">区分12</form:option>
						...
						<div class="control-group">
							<label class="control-label" for="inputError">品號2</label>
...
$(function(){
	...
	$('#stockGubun').change(function(){
		...
		if(stockGubun!='s001' && quantity && stockGubun){
			if(stockForm.numberCheck(stockGubun)){
				quantity = quantity*-1;
			}else{
				quantity = quantity*-1;
