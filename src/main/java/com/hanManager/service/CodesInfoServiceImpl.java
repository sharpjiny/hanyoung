...
@Service
public class CodesInfoServiceImpl implements CodesInfoService {
	...
	public List<HashMap<String, Object>> selectCodesInfoList(HashMap<String, Object> params) throws Exception {
		...
		return codesInfoMapper.selectCodesInfoList(params);
	}
	...
	public Integer insert(HashMap<String, Object> params) throws Exception {
		try {
	        int retCode = 1;
	        codesInfoMapper.insertCodesInfo(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
	...
	public Integer update(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
	        codesInfoMapper.updateCodesInfo(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
			throw new Exception(e.getMessage());
	...
	public Integer delete(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
	        codesInfoMapper.deleteCodesInfo(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
			throw new Exception(e.getMessage());
