...
@Service
public class ProductionWeldingServiceImpl implements ProductionWeldingService {
	...
	public List<HashMap<String, Object>> selectPrdtWeldingList(HashMap<String, Object> params) throws Exception {
		...
		return productionWeldingMapper.selectPrdtWeldingList(params);
	}
	...
	public HashMap<String, Object> prdtWeldingSave(HashMap<String, Object> params) throws Exception {
		...
		if(ilist.size() > 0){
			for(int i=0; i<ilist.size();i++){
				...
				ipCnt += insertPrdtStatusWelding(ilist.get(i));
		...
		if(ulist.size() > 0){
			for(int i=0; i<ulist.size();i++){
				...
				if("OK".equals(ulist.get(i).get("IS_CHECK"))){
					...
					upCnt += updatePrdtStatusWelding(ulist.get(i));
				}
			}
		...
		if(dlist.size() > 0){
			for(int  i=0; i<dlist.size();i++){
				...
				dpCnt += deletePrdtStatusWelding(dlist.get(i));
	...
	public Integer insertPrdtStatusWelding(HashMap<String, Object> params) throws Exception {
		try {
	        int retCode = 1;
	        productionWeldingMapper.insertPrdtStatusWelding(params);
	        ...
	        /*if("product02".equals(params.get("PRODUCT_GUBUN")) || "product05".equals(params.get("PRODUCT_GUBUN"))){
	        	if(params.get("PROD_ID") == null || "".equals(params.get("PROD_ID"))){
	        		...
	        		list = prdtWeldingMapper.selectPrdtWeldingId(params);
		        	params.put("PROD_ID", list.get(0).get("CODE"));
	        	}
	        	prdtWeldingMapper.mergePrdtStock(params);
	        }*/
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
	...
	public Integer updatePrdtStatusWelding(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
			productionWeldingMapper.updatePrdtStatusWelding(params);
	...
	public Integer deletePrdtStatusWelding(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
			productionWeldingMapper.deletePrdtStatusWelding(params);
	        
	        // 재고 테이블 update
	        /*if("product02".equals(params.get("PRODUCT_GUBUN")) || "product05".equals(params.get("PRODUCT_GUBUN"))){
	        	prdtWeldingMapper.deletePrdtStock(params);
	        }*/
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
	...
	public Integer insertPrdtMtrlsUsage(HashMap<String, Object> params) throws Exception {
		try {
	        int retCode = 1;
	        productionWeldingMapper.insertPrdtMtrlsUsage(params);
	...
	public Integer updatePrdtMtrlsUsage(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
			productionWeldingMapper.updatePrdtMtrlsUsage(params);
	...
	public Integer deletePrdtMtrlsUsage(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
			productionWeldingMapper.deletePrdtMtrlsUsage(params);
	...
	public Integer insertToMtrlsInOut(HashMap<String, Object> params) throws Exception {
		try {
	        ...
	        if(!"".equals(insertMap.get("THICKNESS_1")) && insertMap.get("THICKNESS_1") != null){
	        	...
	        	productionWeldingMapper.insertToMtrlsInOut(insertMap);
	        }
