...
@Service
public class MtrlsInfoServiceImpl implements MtrlsInfoService {
	...
	public List<HashMap<String, Object>> selectMtrlsInfoList(HashMap<String, Object> params) throws Exception {
		...
		return mtrlsInfoMapper.selectMtrlsInfoList(params);
	}
	...
	public Integer insert(HashMap<String, Object> params) throws Exception {
		try {
	        int retCode = 1;
	        mtrlsInfoMapper.insertMtrlsInfo(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
	...
	public Integer update(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
	        mtrlsInfoMapper.updateMtrlsInfo(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
			throw new Exception(e.getMessage());
	...
	public Integer delete(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
	        mtrlsInfoMapper.deleteMtrlsInfo(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
			throw new Exception(e.getMessage());
