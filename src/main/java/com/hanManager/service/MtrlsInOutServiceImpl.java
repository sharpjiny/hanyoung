...
@Service
public class MtrlsInOutServiceImpl implements MtrlsInOutService {
	...
	public List<HashMap<String, Object>> selectMtrlsInOutList(HashMap<String, Object> params) throws Exception {
		...
		return mtrlsInOutMapper.selectMtrlsInOutList(params);
	}
	
	@SuppressWarnings("unchecked")
	@Override
	public HashMap<String, Object> mtrlsInOutSave(HashMap<String, Object> params) throws Exception {
	...
	public Integer insert(HashMap<String, Object> params) throws Exception {
		try {
	        int retCode = 1;
	        mtrlsInOutMapper.insertMtrlsInOut(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
	...
	public Integer update(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
	        mtrlsInOutMapper.updateMtrlsInOut(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
			throw new Exception(e.getMessage());
	...
	public Integer delete(HashMap<String, Object> params) throws Exception {
		try {
			int retCode = 1;
	        mtrlsInOutMapper.deleteMtrlsInOut(params);
			return retCode;
		}catch (Exception e) {
			e.printStackTrace();
			throw new Exception(e.getMessage());
