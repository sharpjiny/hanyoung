...
public class PackingInspectionProduce {
    ...
    private Integer faultyL;	// 증착,조립불량 l
	...
	public Integer getFaultyL() {
		return faultyL;
	}
	public void setFaultyL(Integer faultyL) {
		this.faultyL = faultyL;
	}
