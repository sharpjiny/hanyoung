...
import com.hanManager.mapper.ProductionCoatingMapper;
import com.hanManager.service.ProductionCoatingService;
import com.hanManager.web.util.LoginManager;

@Controller
@RequestMapping(value={"/production/coating/"})
public class ProdcutCoatingController extends DefaultController{
	@Autowired CommonCodeMapper codeMapper;
	@Autowired ProductionCoatingService productionCoatingService;
	@Autowired ProductionCoatingMapper productionCoatingMapper;
	...
	public String page(Model model, @RequestParam HashMap<String, Object> params) throws UnknownHostException{
		...
		return TILESForder+"/coating/list"+Constant.TILES;
	}
	...
	public @ResponseBody Map<String, Object> prodNmList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_NM", productionCoatingMapper.selectPrdtCoatingNm(params));
	...
	public @ResponseBody Map<String, Object> prodDtlNmList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_DTL_NM", productionCoatingMapper.selectPrdtCoatingDtlNm(params));
	...
	public @ResponseBody Map<String, Object> prodIdList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_ID", productionCoatingMapper.selectPrdtCoatingId(params));
		
		return result;
	}
	
	@SuppressWarnings("null")
	@RequestMapping(value={"getCoatingDtlList"})
	public @ResponseBody Map<String, Object> getCoatingDtlList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_DTL_LIST", productionCoatingMapper.getCoatingDtlList(params));
	...
	public @ResponseBody Map<String, Object> getPrice(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PRICE", productionCoatingMapper.getPrice(params));
		return result;
	}
	...
	public @ResponseBody List<HashMap<String, Object>> list(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		result = productionCoatingMapper.selectPrdtCoatingList(params);
	...
	public @ResponseBody HashMap<String, Object> save(Model model, @RequestBody HashMap<String, Object> params) throws Exception{
	    ...
	    result = productionCoatingService.prdtCoatingSave(params);
