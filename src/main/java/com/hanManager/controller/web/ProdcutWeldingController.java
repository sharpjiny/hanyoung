...
import com.hanManager.mapper.ProductionWeldingMapper;
import com.hanManager.service.ProductionWeldingService;
import com.hanManager.web.util.LoginManager;

@Controller
@RequestMapping(value={"/production/welding/"})
public class ProdcutWeldingController extends DefaultController{
	@Autowired CommonCodeMapper codeMapper;
	@Autowired ProductionWeldingService productionWeldingService;
	@Autowired ProductionWeldingMapper productionWeldingMapper;
	...
	public String page(Model model, @RequestParam HashMap<String, Object> params) throws UnknownHostException{
		...
		return TILESForder+"/welding/list"+Constant.TILES;
	}
	...
	public @ResponseBody Map<String, Object> prodNmList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_NM", productionWeldingMapper.selectPrdtWeldingNm(params));
	...
	public @ResponseBody Map<String, Object> prodDtlNmList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_DTL_NM", productionWeldingMapper.selectPrdtWeldingDtlNm(params));
	...
	public @ResponseBody Map<String, Object> prodIdList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_ID", productionWeldingMapper.selectPrdtWeldingId(params));
		
		return result;
	}
	
	@SuppressWarnings("null")
	@RequestMapping(value={"getWeldingDtlList"})
	public @ResponseBody Map<String, Object> getWeldingDtlList(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PROD_DTL_LIST", productionWeldingMapper.getWeldingDtlList(params));
	...
	public @ResponseBody Map<String, Object> getPrice(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		Map<String, Object> result = new HashMap<String, Object>();
		result.put("PRICE", productionWeldingMapper.getPrice(params));
		return result;
	}
	...
	public @ResponseBody List<HashMap<String, Object>> list(Model model, @RequestParam HashMap<String, Object> params) throws Exception{
		...
		result = productionWeldingMapper.selectPrdtWeldingList(params);
	...
	public @ResponseBody HashMap<String, Object> save(Model model, @RequestBody HashMap<String, Object> params) throws Exception{
	    ...
	    result = productionWeldingService.prdtWeldingSave(params);
